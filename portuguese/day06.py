...
def day06():
    ...
    while v.despertar == True:
        ...
        despertar1 = fonte2.render("Deveria dormir mais, hoje é sabado...", 1, WHITE)
        SCREEN.blit(despertar1, (100,100))
        pygame.display.update()
        pygame.time.wait(1000)
        despertar1 = fonte2.render("Mas é sempre tão dificil ficar tanto na cama...", 1, WHITE)
    ...
    while v.sair_trabalhar == True:
        ...
        #pergunta 3 do dia
        pergunta06 = pygame.image.load(r'imagens\pergunta6.png')
        SCREEN.blit(pergunta06, (1015,y_pergunta))
        
        #criar botoes com texto
        escolha01_6 = pygame.image.load(r'imagens\escolha061.png')
        SCREEN.blit(escolha01_6, (xbotao,botao01))
        escolha02_6 = pygame.image.load(r'imagens\escolha062.png')
        SCREEN.blit(escolha02_6, (xbotao,botao03))
        escolha03_6 = pygame.image.load(r'imagens\escolha063.png')
        SCREEN.blit(escolha03_6, (xbotao,botao04))
        escolha04_6 = pygame.image.load(r'imagens\escolha064.png')
        SCREEN.blit(escolha04_6, (xbotao,botao05))
    ...
    while v.no_trabalho == True:
        ...
        pygame.mixer.Sound.set_volume(som_cidade,1)
        v.peloop = True
        v.pex = 100
