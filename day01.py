...
def day01():
    ...
    pygame.mixer.init()
    #definindo sons
    background_music = pygame.mixer.Sound(r'audio\musica triste - Dream away (No Vocals).mp3')
    reclamacao = pygame.mixer.Sound(r'audio\reclamar.mp3')
    sussurros = pygame.mixer.Sound(r'audio\sussurros.mp3')
    grito01 = pygame.mixer.Sound(r'audio\grito 01.mp3')
    ...
    fonte1 = pygame.font.SysFont(font_default, 100)
    fonte2 = pygame.font.SysFont(font_default, 50)
    fonte3 = pygame.font.SysFont(font_default, 120)
    SCREEN = pygame.display.set_mode((WINDOW_WIDTH, WINDOW_HEIGHT))
    ...
    while v.despertar == True:
        ...
        despertar1 = fonte2.render("Another day starting...", 1, WHITE)
        SCREEN.blit(despertar1, (100,100))
        pygame.display.update()
        pygame.time.wait(1000)
        despertar1 = fonte2.render("It's like it's neverending...", 1, WHITE)
    ...
    while v.no_trabalho == True:
        ...
        if v.carro == True:
            ...
            pygame.mixer.Sound.set_volume(som_carro,1)
