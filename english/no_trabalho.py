...
def trabalho():
    ...
    while v.no_trabalho == True:
     ...
     frase01 = fonte.render("Everything was good... until", 1, WHITE)
     ...
     pygame.display.update()
     frase03 = fonte.render("what should you do?", 1, WHITE)
     ...
     while v.looptrabalho == True:
      ...
      #identificar qual botao esta sendo apertado:
        ...
        if event.key == pygame.K_RETURN:
         ...
         if localdoy == 350:
             v.depre += 1
             frase04 = fonte.render("You're feeling worst", 1, WHITE)
         ...
         if localdoy == 400:
             v.depre -= 1
             frase04 = fonte.render("You're feeling better", 1, WHITE)
             SCREEN.blit(frase04, (100,500))
             pygame.display.update()
             pygame.time.wait(3000)
             SCREEN.fill(BLACK)
