...
def day05():
    ...
    while v.despertar == True:
        ...
        despertar1 = fonte2.render("Another day...another disappointment", 1, WHITE)
    ...
    while v.no_trabalho == True:
        SCREEN.fill((0,0,0))
        pygame.display.update()
        desanimo4 = fonte2.render("I can't believe I'm late...", 1, WHITE)
        desanimo5 = fonte2.render("My boss won't like it...", 1, WHITE)
